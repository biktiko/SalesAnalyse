                        ...
                        <div style={{ background: 'var(--bg-secondary)', padding: '18px', borderRadius: '24px', border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', gap: '18px' }}>
                           <div>
                              ...
                              <div style={{ display: 'flex', gap: '8px' }}>
                                 <input type="text" inputMode="text" placeholder="Սկսած..." value={draftFilters.diffPercentMin} onChange={e => setDraftFilters({...draftFilters, diffPercentMin: e.target.value})} style={{ flex: 1, minWidth: 0, background: 'var(--bg-primary)', border: 'none', borderRadius: '14px', padding: '12px 14px', fontSize: '14px', color: 'var(--text-primary)', outline: 'none' }} />
                                 <input type="text" inputMode="text" placeholder="Մինչև..." value={draftFilters.diffPercentMax} onChange={e => setDraftFilters({...draftFilters, diffPercentMax: e.target.value})} style={{ flex: 1, minWidth: 0, background: 'var(--bg-primary)', border: 'none', borderRadius: '14px', padding: '12px 14px', fontSize: '14px', color: 'var(--text-primary)', outline: 'none' }} />
                              </div>
                           </div>
                           <div>
                              ...
                              <div style={{ display: 'flex', gap: '8px' }}>
                                 <input type="text" inputMode="text" placeholder="Սկսած..." value={draftFilters.diffNumericMin} onChange={e => setDraftFilters({...draftFilters, diffNumericMin: e.target.value})} style={{ flex: 1, minWidth: 0, background: 'var(--bg-primary)', border: 'none', borderRadius: '14px', padding: '12px 14px', fontSize: '14px', color: 'var(--text-primary)', outline: 'none' }} />
                                 <input type="text" inputMode="text" placeholder="Մինչև..." value={draftFilters.diffNumericMax} onChange={e => setDraftFilters({...draftFilters, diffNumericMax: e.target.value})} style={{ flex: 1, minWidth: 0, background: 'var(--bg-primary)', border: 'none', borderRadius: '14px', padding: '12px 14px', fontSize: '14px', color: 'var(--text-primary)', outline: 'none' }} />
                              </div>
                           </div>
                        </div>
